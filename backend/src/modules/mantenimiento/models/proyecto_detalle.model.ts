...
export const proyectoDetalleConfig: TablaConfig = {
  ...
  "columnasFiltroOrden": [
    ...
    "fecha_firma_contrato_original",
    "numero_contrato_modificatorio",
    "fecha_firma_contrato_modificatorio",
    "acuerdo_ministerial_original",
    "acuerdo_ministerial_modificatorio",
  ...
  "columnasFiltroMenu": [
    ...
    },
    {
      ...
      "tipo": "foreign_key",
      "tablaReferencia": "municipio",
      "columnaLabel": "nombre",
      "renderizado": "combobox"
    },
    {
      "columna": "empresa_contratante_id",
      "tipo": "foreign_key",
    ...
    {
      "columna": "contacto_contratante_id",
      "tipo": "foreign_key",
      "tablaReferencia": "contacto_entidad",
      "columnaLabel": "cargo",
      "renderizado": "select"
    },
    {
