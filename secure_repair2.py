...
# Just extract everything up to `const TABLAS_MANTENIMIENTO`
top_part = content.split('const TABLAS_MANTENIMIENTO')[0]

# And everything from `export default function MantenimientoTablas()`
bottom_part = 'export default function MantenimientoTablas' + content.split('export default function MantenimientoTablas')[1]
...
new_content = top_part + out_ts + bottom_part
