              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                  ...
                  <div className="mt-3 text-right">
                    <button type="button" onClick={() => alert("Módulo de permisos avanzados en construcción")} className="text-[10px] font-bold text-[#9B0F06] hover:text-[#5E0006] transition-colors inline-flex items-center gap-1.5">
