    ...
    try {
      ...
      if (data && data.success && data.data) {
        ...
        return {
          ...
          departamentoId: raw.departamentoId || raw.departamento_id || '',
          municipioId: raw.municipioId || raw.municipio_id || '',
          departamentoFinId: raw.departamentoFinId || raw.departamento_fin_id || '',
          municipioFinId: raw.municipioFinId || raw.municipio_fin_id || '',
          kilometroInicio: raw.kilometroInicio ?? raw.kilometro_inicio ?? null,
          kilometroFin: raw.kilometroFin ?? raw.kilometro_fin ?? null,
          direccionFin: raw.direccionFin || raw.direccion_fin || '',
