...
const splitToken = 'export default function MantenimientoTablas() {';
...
// Fix the import to include EstadoVacio
let finalHeader = header;
if (!finalHeader.includes('EstadoVacio')) {
    finalHeader = finalHeader.replace("import { useCustomToast } from '@/hooks/useCustomToast'", "import { useCustomToast } from '@/hooks/useCustomToast'\nimport { EstadoVacio } from '@/components/ui/EstadoVacio'");
}

fs.writeFileSync(path, finalHeader + splitToken + newComponent, 'utf8');
